            ...
            if frame_id in frame_types:
                ...
                if frame_id.startswith(b'T'):  # a text field
                    ...
                    if mime_types.startswith('image/'):
                        ...
                        print("Writing image file", picture_filename)
